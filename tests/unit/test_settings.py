...
class TestAppSettingsValidation:
    ...
    def test_extra_env_vars_ignored(self) -> None:
        """Verify extra environment variables with HELLO_WORLD_ prefix are ignored."""
        with patch.dict(
...
class TestGetSettingsSingleton:
    ...
    def test_cache_clear_creates_new_instance(self) -> None:
        ...
        get_settings.cache_clear()
        with patch.dict(os.environ, {"HELLO_WORLD_LOG_LEVEL": "ERROR"}, clear=True):
            settings2 = get_settings()
...
class TestSettingsIntegration:
    ...
    def test_settings_reflect_environment_changes_after_cache_clear(self) -> None:
        ...
        with patch.dict(os.environ, {"HELLO_WORLD_LOG_LEVEL": "INFO"}, clear=True):
            settings1 = get_settings()
